...
import { ref } from "vue";
import { useBannerImages } from "@/components/features/peliculas/composables/useBannerImages";
...
const BASE_PELICULA = {
  ...
  banner_image: {
    ...
    srcset:
      "https://cdn.example.com/film_f01_large.jpg 300w, https://cdn.example.com/film_f01.jpg 1920w",
    sizes: "100vw",
  },
  carousel_images: [
...
describe("useBannerImages", () => {
  describe("bannerImages", () => {
    ...
    it("uses imageURL as src when banner_image is absent", () => {
      ...
      const { bannerImages } = useBannerImages(pelicula);
      expect(bannerImages.value[0].src).toBe(
        "https://cdn.example.com/film_f01.jpg",
      );
    });
    ...
    it("appends carousel images after main image", () => {
      ...
      expect(bannerImages.value[1].href).toBe(
        "https://cdn.example.com/film_f02.jpg",
      );
      expect(bannerImages.value[2].href).toBe(
        "https://cdn.example.com/film_f03.jpg",
      );
    });
  ...
  describe("onImageError", () => {
    ...
    it("removes carousel image when its path errors", () => {
      ...
      expect(
        bannerImages.value.find(
          (i) => i.href === "https://cdn.example.com/film_f02.jpg",
        ),
      ).toBeUndefined();
    });
