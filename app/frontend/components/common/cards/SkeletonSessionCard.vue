<template>
  <div class="flex flex-col items-start gap-200 animate-pulse">
    <!-- Skeleton image -->
    <div class="relative w-full aspect-[2/3] rounded-200 bg-neutrals-200 dark:bg-neutrals-400 h-[320px]">
      <!-- Overlay -->
      <div
